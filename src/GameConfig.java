public class GameConfig {
    public static final String ASSETS_DIR = "./keys";
    ...
    public static final String WORDS_TXT_PATH = "./words.txt";
    public static final String CLICK_WAV_PATH = "./wav/click3_1.wav";
